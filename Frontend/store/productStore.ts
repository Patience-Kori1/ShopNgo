...
export const useProductStore = create<ProductsState>((set, get) => ({//set=modifer le state, get=accéder au state
    ...
    //Méthode pour récupérer les categories depuis l'API
    ...
    //Méthode pour récupérer les produits d'une categorie depuis l'API
    ...
    //Méthode pour récupérer le produits recherché
